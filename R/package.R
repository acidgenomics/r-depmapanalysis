...
#'   as_tibble cacheURL camelCase capture.output colData complete.cases decode
#'   do.call encode geneSynonyms import lapply makeDimnames
#'   makeSummarizedExperiment mapGenesToRownames mcols melt metadata metadata<-
#'   packageName packageVersion pasteURL reorder rbind rowData showHeader
#'   showSlotInfo snakeCase str_match t
