...
#'   cacheURL camelCase complete.cases decode geneSynonyms import makeDimnames
#'   makeGRangesFromEnsembl makeSummarizedExperiment mapGenesToRownames mcols
#'   melt packageName packageVersion reorder snakeCase
